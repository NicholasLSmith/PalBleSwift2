...
@interface CBATTRequest (SWIFT_EXTENSION(RxBluetoothKit))
...
@interface CBCentral (SWIFT_EXTENSION(RxBluetoothKit))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end
...
SWIFT_AVAILABILITY(watchos,introduced=4.0) SWIFT_AVAILABILITY(tvos,introduced=11.0) SWIFT_AVAILABILITY(macos,introduced=10.13) SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface CBL2CAPChannel (SWIFT_EXTENSION(RxBluetoothKit))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end
...
@interface CBPeripheralManager (SWIFT_EXTENSION(RxBluetoothKit))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end


SWIFT_CLASS("_TtC14RxBluetoothKit34CBPeripheralManagerDelegateWrapper")
@interface CBPeripheralManagerDelegateWrapper : NSObject <CBPeripheralManagerDelegate>
...
- (void)peripheralManager:(CBPeripheralManager * _Nonnull)peripheral didUnpublishL2CAPChannel:(CBL2CAPPSM)PSM error:(NSError * _Nullable)error;
- (void)peripheralManager:(CBPeripheralManager * _Nonnull)peripheral didOpenL2CAPChannel:(CBL2CAPChannel * _Nullable)channel error:(NSError * _Nullable)error SWIFT_AVAILABILITY(watchos,introduced=4.0) SWIFT_AVAILABILITY(tvos,introduced=11.0) SWIFT_AVAILABILITY(macos,introduced=10.13) SWIFT_AVAILABILITY(ios,introduced=11.0);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
